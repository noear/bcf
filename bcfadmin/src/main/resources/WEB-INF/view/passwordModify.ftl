...
<detail>
    <table>
        <tr>
            <td>原密码：</td>
            <td><input type="text" id="oldPass" placeholder="请输入原密码"></td>
        </tr>
        <tr>
            <td>新密码：</td>
            <td><input type="text" id="newPass" placeholder="请输入新密码"></td>
        </tr>
        <tr>
            <td>确认新密码：</td>
            <td><input type="text" id="conNewPass" placeholder="请确认新密码"></td>
        </tr>
        <tr>
            <td></td>
            <td>
                <button onclick="confirm()">修改</button>
            </td>
        </tr>
    </table>
</detail>
